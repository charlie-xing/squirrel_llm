/**
 * @name Fitness Coach
 * @description Provide workout and nutrition advice
 * @author AI Assistant
 * @version 1.0
...
function runPlugin(userPrompt) {
    log("Fitness Coach plugin running with prompt: " + userPrompt);

    return {
        content: "<div style='padding: 20px; font-family: system-ui;'>" +
                "<h2 style='color: #007AFF;'>Fitness Coach</h2>" +
                "<p style='color: #666;'><strong>Mode:</strong> Chat</p>" +
                "<p style='color: #666;'><strong>Your Input:</strong> " + userPrompt + "</p>" +
                "<div style='margin-top: 20px; padding: 15px; background: #f5f5f5; border-radius: 8px;'>" +
                "<p>This is a demo plugin for <strong>Fitness Coach</strong>.</p>" +
                "<p>Provide workout and nutrition advice</p>" +
